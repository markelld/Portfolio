      ...
      <Layout> 
        <div className="about-main"> 
          <div className="info"> 
            ...
            <p className="paragraph">Developing software has created a hunger to learn, creating new ways for me to innovate. I see Software engineeing as an outlet to express myself, it kind of feels like its art. Prior to developing I worked in the hospitality industry as a Bartender.  
